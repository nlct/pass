...
If you want to check the upload directories or requeue uploads, use the Admin<?php
   echo PassConfig::MENU_SEP, $pass->get_admin_upload_dirs_link('Upload Directories'); ?> menu link.
If you want to check for error messages from the backend see the
Admin<?php echo PassConfig::MENU_SEP, $pass->get_admin_viewlogs_link(); ?> page. Common error
...
Admin<?php echo PassConfig::MENU_SEP, $pass->get_admin_sessions_link(); ?> menu link.

<p>If you need to make any disruptive changes you can check if there's anyone 
currently logged in with the Admin<?php echo PassConfig::MENU_SEP, $pass->get_admin_whosonline_link(); ?> 
menu link. You can add a site-wide message banner and switch the site to maintenance mode in the 
Admin<?php echo PassConfig::MENU_SEP, $pass->get_admin_config_link(); ?> page.
...
maintenance work is required on the backend, see the Admin<?php
   echo PassConfig::MENU_SEP, $pass->get_admin_maintenance_link(); ?> page.

<p>See also the <a href="https://github.com/nlct/pass/tree/main/docs/server-pass">documentation</a> on GitHub.
